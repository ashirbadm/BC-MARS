...
unsigned KernelConfig::setNumberOfBlocks(unsigned lnblocks) {
	return (nblocks = lnblocks);
}
unsigned KernelConfig::setNumberOfBlocksPerSM(unsigned lnblocks) {
	return (nblocks = lnblocks * getNumberOfSMs());
}
unsigned KernelConfig::setNumberOfBlockThreads(unsigned lblocksize) {
	return (blocksize = lblocksize);
}
