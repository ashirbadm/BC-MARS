...
*/
extern "C" void lonestar_gpu(unsigned *,unsigned *,unsigned *,unsigned *,unsigned *edgessrc,unsigned *edgesdst,unsigned hnodes,unsigned hedges,unsigned *hdist,unsigned *nodesigma,unsigned *edgesigma,unsigned count,unsigned *sources,cudaDeviceProp *,bool BM_COMP,unsigned *nerr);
...
int betweenness_centrality_parallel(unsigned hnodes,unsigned hedges,unsigned *rowptrs,unsigned *columnindexes, unsigned *edgessrc,unsigned *noutgoing,unsigned *sources,unsigned source_count,unsigned *nodedist, unsigned *nodesigma, unsigned *edgesigma,omp_lock_t *,int num_threads);
